...
@SuppressWarnings({"deprecation", "SuspiciousNameCombination", "ConstantConditions"})
public abstract class CameraActivity extends AppCompatActivity
  ...
  private boolean isHardwareLevelSupported(
      ...
      if (deviceLevel == CameraCharacteristics.INFO_SUPPORTED_HARDWARE_LEVEL_LEGACY) {
          ...
          result = android.hardware.camera2.CameraMetadata.INFO_SUPPORTED_HARDWARE_LEVEL_FULL <= deviceLevel;
      }
      return result;
  }
